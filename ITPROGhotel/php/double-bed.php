...
$stmt = $conn->prepare("SELECT * FROM rooms WHERE type = 'Double' AND availability = 0");
$stmt->execute();
$result = $stmt->get_result();
$doubleRooms = $result->fetch_all(MYSQLI_ASSOC);
$stmt->close();
...
<head>
    <meta charset="utf-8">
    <title>Double Bed Rooms</title>
    <link href="../styles.css" rel="stylesheet" type="text/css">
</head>
<body class="loggedin">
    <div class="header">
        <h1>Double Bed Rooms</h1>
    </div>
    <nav class="sidebar">
    ...
    <div class="content">
        <h2>Available Double Bed Rooms</h2>
            ...
            <?php foreach ($doubleRooms as $room): ?>
                <div class="grid-element">
                    ...
                    <form action="add-to-cart.php" method="post">
                        ...
                        <input type="hidden" name="name" value="Double Bed Room">
